...
import com.squid.core.jdbc.vendor.redshift.postgresql.PostgresqlStatistics;

public class RedshiftVendorSupport extends DefaultVendorSupport {
	
	public static final String VENDOR_ID = IMetadataEngine.REDSHIFT_NAME;

	static final VendorMetadataSupport REDSHIFT = new RedshiftMetadataSupport();
	...
	public IJDBCDataFormatter createFormatter(DataFormatter formatter,
		...
		return new RedshiftJDBCDataFormatter(formatter, connection);
	}
