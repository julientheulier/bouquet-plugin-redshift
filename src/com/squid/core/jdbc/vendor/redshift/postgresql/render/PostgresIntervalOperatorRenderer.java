...
import com.squid.core.sql.db.render.IntervalOperatorRenderer;
 ...
 *
 */
public class PostgresIntervalOperatorRenderer
extends IntervalOperatorRenderer
{
	...
	public String prettyPrint(SQLSkin skin, OperatorDefinition opDef, String[] args) throws RenderingException {
		int step = new Integer(args[0]);
		String suffix ="";
		if (step>1) {
			suffix="S";
		}
		String txt = INTERVAL + " '" + args[0] + " " + MODE + suffix + "'";
		return txt;
	}
