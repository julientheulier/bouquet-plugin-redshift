...
public class PosStringRenderer
extends BaseOperatorRenderer
{
	...
	public String prettyPrint(SQLSkin skin, OperatorDefinition opDef, String[] args) throws RenderingException {
		...
		if (args != null) {
			if (args.length!=2) throw new RenderingException("invalid syntax for POSITION operator");
			principalstring = args[0];
			substring = args[1];
		}
		String str = "POSITION("+substring+ " IN "+principalstring+")";
		return str;
	}
